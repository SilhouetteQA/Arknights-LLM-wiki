...
- [x] **Step 1: 写 failing test — 验证概念 JSON Schema 包含所有必填字段**
...
- [x] **Step 3: 实现 worldbuilding_schema.py**
...
- [x] **Step 3: 实现 worldbuilding_prompts.py**
...
- [x] **Step 3: 实现 worldbuilding_processor.py**
...
- [x] **Step 3: 实现 worldbuilding_orchestrator.py**
