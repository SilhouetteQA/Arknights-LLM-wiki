...
- [ ] **Step 1: Write failing tests for normalize_participant**
...
- [ ] **Step 3: Implement normalize_participant**
...
- [ ] **Step 5: Write failing tests for collect_from_v1**
...
- [ ] **Step 7: Implement collect_from_v1**
...
- [ ] **Step 9: Write failing tests for normalize_and_merge**
...
- [ ] **Step 11: Implement normalize_and_merge**
...
- [ ] **Step 13: Write failing tests for filter_targets and parse_keep_list**
...
- [ ] **Step 15: Implement filter_targets and parse_keep_list**
...
- [ ] **Step 17: Write failing tests for context injection**
...
- [ ] **Step 19: Implement _cut_lines, inject_context, get_operator_archive**
...
- [ ] **Step 1: Write failing tests for character prompt functions**
...
- [ ] **Step 3: Implement character prompt functions in prompt_builder.py**
...
- [ ] **Step 1: Write failing tests for character output validation**
...
- [ ] **Step 3: Implement validate_character_output in post_processor.py**
...
- [ ] **Step 1: Write failing integration test for character extraction**
...
- [ ] **Step 3: Implement character extraction functions in orchestrator.py**
...
- [ ] **Step 2: Run trial (dry-run first — collect stats without LLM calls)**
...
- [ ] **Step 3: Run trial with LLM calls**
