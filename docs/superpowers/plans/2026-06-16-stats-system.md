...
- [ ] **Step 3: Implement record methods**
...
- [ ] **Step 1: Write failing test for _collect_content**
...
- [ ] **Step 3: Implement _collect_content**
...
- [ ] **Step 1: Write failing test for _get_raw_data**
...
- [ ] **Step 3: Implement _get_raw_data and _resolve_data_dir**
...
- [ ] **Step 1: Write failing tests for snapshot write + finish**
...
- [ ] **Step 3: Implement _build_snapshot + _write_snapshot + update finish**
...
- [ ] **Step 3: Implement StatsReporter**
...
- [ ] **Step 2: Verify CLI works (no data yet, expect empty)**
...
- [ ] **Step 1: Update run_seed to use StatsCollector**
...
- [ ] **Step 2: Verify seed runs with stats integration**
...
- [ ] **Step 2: Run seed and verify stats CLI**
